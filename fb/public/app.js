...
function formSubmit(e) {
  ...
  //send message values
  sendMessage(name, email, nombor, Kategori, namaEvent, qrImg);

  //Show Alert Message(5)
  document.querySelector('.alert').style.display = 'block';
  let imgSrc = "https://api.qrserver.com/v1/create-qr-code/?size=200x200&data="+name;
  qrImg.src = imgSrc;
...
function sendMessage(name, email, nombor, Kategori, namaEvent, qrImg) {
